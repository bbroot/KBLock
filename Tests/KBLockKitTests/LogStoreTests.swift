...
struct LogStoreTests {
    ...
    func defaultDirectoryUsesBundleIdentity() {
        ...
        let releaseDirectory = support.appending(path: "KBLock", directoryHint: .isDirectory).path
        let devDirectory = support.appending(path: "com.bbroot.KBLock.dev", directoryHint: .isDirectory).path

        #expect(LogStore.defaultDirectory(for: "com.bbroot.KBLock").path == releaseDirectory)
        #expect(LogStore.defaultDirectory(for: "com.bbroot.KBLock.dev").path == devDirectory)
