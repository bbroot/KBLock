...
struct ConfigBackupTests {
    ...
    func prettyEncoding() throws {
        ...
        #expect(text.contains("com.bbroot.KBLock.backup"))
    ...
    @Test("read() rejects valid JSON that isn't a KBLock backup")
    ...
    func readsDamaged() {
        ...
        let json = #"{"format": "com.bbroot.KBLock.backup", "minReader": 1, "payload": "broken"}"#
