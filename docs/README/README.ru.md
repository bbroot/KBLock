...
- **Управление из строки меню** — включение/выключение, просмотр текущего источника и счётчик срабатываний прямо в строке меню.
- **Глобальная горячая клавиша** — включайте и выключайте блокировку настраиваемым сочетанием клавиш.
