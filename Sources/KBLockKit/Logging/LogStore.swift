...
public final class LogStore {
    ...
    private static let log = Logger(subsystem: "com.bbroot.KBLock", category: "LogStore")
    static func defaultDirectory(for bundleIdentifier: String?) -> URL {
        if bundleIdentifier == "com.bbroot.KBLock" {
            return URL.applicationSupportDirectory.appending(path: "KBLock", directoryHint: .isDirectory)
        }
