...
@MainActor
final class KBLockUserDriver: NSObject, SPUUserDriver {
    private static let log = Logger(subsystem: "com.bbroot.KBLock", category: "Updater")
    ...
    private let autoInstall =
        ProcessInfo.processInfo.environment["KBLOCK_UPDATE_AUTO_INSTALL"] == "1"
    #endif
