...
struct BackupSettingsPane: View {
    ...
    private static let log = Logger(subsystem: "com.bbroot.KBLock", category: "backup")
    ...
    private func exportConfiguration() {
        ...
        panel.nameFieldStringValue = "KBLock Backup.\(ConfigBackup.fileExtension)"
    ...
    private func importErrorNote(_ error: BackupReadError) -> some View {
        ...
        case .notABackup:
            inlineNote("This file isn't a KBLock backup.", systemImage: icon, tint: DS.Palette.warning)
        case .damaged:
        ...
        case .incompatibleVersion(let appVersion):
            HStack(spacing: DS.Spacing.md) {
                ...
                Text("This backup was made by a newer KBLock (\(appVersion)). Update KBLock, then try again.")
