...
struct AboutView: View {
    ...
    private static let repoURL = URL(string: "https://github.com/bbroot/KBLock")!
    ...
    private var stateIcon: Image {
        state.isLocked ? Image(nsImage: .kbLockAppIcon) : Image("AppIconUnlocked")
    }
}

/// A small sheet crediting the open-source libraries KBLock builds on.
