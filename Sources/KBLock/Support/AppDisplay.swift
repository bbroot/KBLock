...
extension NSImage {
    /// KBLock's own app icon, loaded robustly from the bundled `AppIcon.icns`
    ...
    @MainActor static var kbLockAppIcon: NSImage {
    ...
    @MainActor static var kbLockAppIconRounded: NSImage {
        let base = kbLockAppIcon
